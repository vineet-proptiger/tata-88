...
/* ─── CONFIG ─────────────────────────────────────────────────── */
import * as tata from '../../../lib/config'

const PROJECTS = {
  [tata.PROJECT_ID]: tata,
}
/* ────────────────────────────────────────────────────────────── */
...
export async function POST(request) {
  try {
    ...
    const projectConfig   = PROJECTS[projectId] || tata
    const SHEET_WEBHOOK   = projectConfig.SHEET_WEBHOOK  || ''
    const PROPTIGER_URL   = projectConfig.PROPTIGER_URL  || ''
    const CITY_ID         = projectConfig.CITY_ID        || ''
    const CITY_SLUG       = projectConfig.CITY_SLUG      || ''
