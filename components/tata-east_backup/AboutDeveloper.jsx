          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                Tata Housing Development Company is one of India's most respected real estate developers, backed by the enduring legacy of the Tata Group. Known for its commitment to quality, innovation, and customer-centricity, Tata Housing has delivered landmark residential and commercial projects across major cities including Mumbai, Pune, Bangalore, Kolkata, Gurgaon, and Chennai. With a vision to provide world-class living experiences and a focus on sustainability, superior construction, and modern amenities, every Tata Housing project reflects trust, transparency, and long-term value for homebuyers.
              </p>
            </div>
