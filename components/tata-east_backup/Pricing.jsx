        ...
        <div className="flex justify-center max-w-6xl mx-auto px-4">
          {units.map((unit, idx) => (
            <div
              ...
              className={`group pricing-card relative bg-white rounded-lg overflow-hidden border border-[#D5C2A8] transition-all duration-500 w-full max-w-[400px] ${unit.isPopular ? "lg:scale-105 z-20" : "z-10"}`}
            >
              {unit.isPopular && (
                <div
