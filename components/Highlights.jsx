...
const highlights = [
  {
    text: '5 storey parking',
    icon: <Building2 {...highlightIconProps} />,
  },
  {
    text: '43 storey high rise towers',
    icon: <MapPin {...highlightIconProps} />,
  },
  {
    text: 'Infinity view swimming pool',
    icon: <Star {...highlightIconProps} />,
  },
  {
    text: 'Multilevel amenities',
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        <h2 style={{
          ...
          Project Highlights:{' '}
          <span style={{ color: 'var(--color-gold)' }}> Tata 88 East</span>
        </h2>
