...
import { PROJECT_ID, PROJECT_NAME, API_ENDPOINT, SHEET_NAME, SECRET_KEY, CITY_DISPLAY } from '../../lib/vanantara/config'
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-1">
      ...
      <div className="flex items-start gap-2 mt-3">
        ...
        <label htmlFor="privacy-lead" className="text-xs text-gray-500 leading-relaxed cursor-pointer" style={{ fontFamily: F_SANS }}>
          ...
          <a href="/vanantara/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: GOLD, textDecoration: 'underline' }}>Privacy Policy</a>
        </label>
      </div>
