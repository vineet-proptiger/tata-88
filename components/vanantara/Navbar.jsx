...
const ProjectLogo = () => (
  <img
    src="/vanantara/images/logo/logo.svg"
        ...
        <div className="lg:hidden bg-[var(--color-bg)] border-t border-gray-100 shadow-lg">
          {navLinks.map(link => (
            <a key={link.name} href={link.href}
              ...
              className="block px-6 py-3.5 text-sm text-[var(--color-text-mid)] hover:bg-[var(--color-bg-light)] border-b border-gray-50 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}>
              {link.name}
            </a>
          ))}
