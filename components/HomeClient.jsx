    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        <a
          ...
          className="flex-1 flex flex-col items-center justify-center gap-1 py-2 !px-0 !rounded-none border-r border-[#151515]/10 text-[#151515]"
          style={{ background: '#E2B853' }}
        >
          <div className="w-[22px] h-[22px] rounded-full border-[1.5px] border-[#151515] flex items-center justify-center animate-ring origin-center">
          ...
          <span style={{ fontSize: '10px', fontWeight: '700', letterSpacing: '0.04em', fontFamily: 'var(--font-jost), Montserrat, sans-serif' }}>CALL FOR DETAILS</span>
        </a>
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex flex-col items-center justify-center gap-1 py-2 !px-0 !rounded-none text-white"
          style={{ background: '#005B4F' }}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
              d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
          </svg>
          <span style={{ fontSize: '10px', fontWeight: '600', letterSpacing: '0.04em', fontFamily: 'var(--font-jost), Montserrat, sans-serif' }}>Enquire</span>
        </button>
        {/* 
        <a
          href="https://wa.me/919718344024?text=Hi%20I%20am%20interested%20in%20Tata%2088%20East%2C%20Kolkata"
